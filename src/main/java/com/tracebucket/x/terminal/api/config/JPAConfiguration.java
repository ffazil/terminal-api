 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = {"com.tracebucket.x.terminal.api.repository.jpa"}, repositoryFactoryBeanClass = CustomRepositoryFactoryBean.class)
@EntityScan(basePackages = {"com.tracebucket.x.terminal.api.domain"})
